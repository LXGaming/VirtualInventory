...
public final class PlayerSlot extends VirtualSlot {
    
    public PlayerSlot(ItemStack itemStack) {
        super(itemStack);
    }
    
    @Override
    public void actionPerformed(ButtonType buttonType, ClickType clickType, Player player) {
    }
}